...
function detailResult(overrides: Partial<PlayerDetailStatisticsResult> = {}): PlayerDetailStatisticsResult {
  return {
    ...
    radarMetrics: [
      { key: 'kda', label: 'KDA', value: 4.2, averageValue: 3.1, playerScore: 80, averageScore: 55, rank: 3, cohortSize: 18, available: true },
      { key: 'killParticipantPercent', label: '参团率', value: 0.7, averageValue: 0.65, playerScore: 60, averageScore: 55, rank: 6, cohortSize: 18, available: true },
      { key: 'creepScorePerGame', label: '场均补刀', value: 300, averageValue: 280, playerScore: 65, averageScore: 55, rank: 4, cohortSize: 18, available: true },
      { key: 'goldGapPerGame', label: '场均经济差', value: 100, averageValue: 50, playerScore: 75, averageScore: 55, rank: 2, cohortSize: 18, available: true },
      { key: 'killPerGame', label: '场均击杀', value: 3, averageValue: 2.5, playerScore: 70, averageScore: 55, rank: 5, cohortSize: 18, available: true },
      { key: 'damagePercent', label: '伤害占比', value: 0.25, averageValue: 0.24, playerScore: 55, averageScore: 55, rank: 7, cohortSize: 18, available: true },
      { key: 'damagePerGame', label: '伤害', value: 26000, averageValue: 21000, playerScore: 72, averageScore: 55, rank: 4, cohortSize: 18, available: true },
      { key: 'deathPerGame', label: '场均死亡', value: 1.6, averageValue: 2.1, playerScore: 68, averageScore: 55, rank: 2, cohortSize: 18, available: true },
    ],
